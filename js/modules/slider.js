function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    // Slider
    /* 
        1. Получить все элементы, с которыми мы будем работать
        2. Нужен индекс, который будет определять наш текущий слайд
        3. Написание функции, который будет заниматься показом наших слайдов
        4. 
    */
